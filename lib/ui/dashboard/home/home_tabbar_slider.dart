...
class _HomeTabbarProductListViewState extends State<HomeTabbarProductListView>
  ...
  final Color _backgroundOn = Colors.transparent;

  final Color _backgroundOff = PsColors.mainColor;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      backgroundColor: const Color(0xFF17234B),
      body: Stack(
  ...
  dynamic _getTextColor(int index) {
    if (index == _currentIndex) {
      // if it's active button
      return PsColors.black;
    } else {
      return const Color(0xFF17234B);
    }
  }
          ...
          Container(
            ...
            child: FloatingActionButton(
              ...
              child: AnimatedBuilder(
                ...
                child: Icon(
                  widget.controller.isDismissed ? Icons.add : Icons.add,
                  color: PsColors.white,
                ),
                builder: (BuildContext context, Widget child) {
                  return Transform(
