            ...
            child: Consumer<ProductDetailProvider>(
              builder: (BuildContext context, ProductDetailProvider provider,
                ...
                if (provider != null &&
                  ...
                  print(
                      'detaillllllll : latest${provider.productDetail.data.defaultPhoto.imgId}');
                  return Stack(
                    children: <Widget>[
...
class __FloatingActionButtonState extends State<_FloatingActionButton> {
  ...
  Widget build(BuildContext context) {
    const String whatsappUrl =
        'https://api.whatsapp.com/send/?phone=919511652917&text=Hello+PickProSupport%21&app_absent=0';
    const String messengerUrl = '173248291002704';
    const String phoneCall = 'https://t.me/bizbackend';
